...
function Track() {
  ...
  const containerData = [
    ...
    { id: "DEF456", location: "Port of Rotterdam", size: "20ft", capacity: "12.08tn", lat: 51.9502, lng: 4.1567 },
    { id: "GHI789", location: "Port of Singapore", size: "20ft", capacity: "15.05tn", lat: 1.2654, lng: 103.8202 },
    { id: "JKL012", location: "Port of Shanghai", size: "40ft", capacity: "21.57tn", lat: 31.2304, lng: 121.4737 },
    { id: "MNO345", location: "Port of Busan New Port ", size: "20ft", capacity: "24.57tn", lat: 31.2308, lng: 121.4778 }
  ];
            ...
            <div className="col-md-6">
              <div className="input-group">
                <input
                  ...
                  placeholder="Enter Container Serial Number"
                  value={serialNumber}
                  onChange={(e) => setSerialNumber(e.target.value)} // Update serial number input
                />
